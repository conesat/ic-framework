 ...
 * @since 2023/6/5
 */
public class VueIndexTemplate {
    public final static String VUE_INDEX_TEMPLATE = """
            <template>
              <div>
            ...
            const onConfirmDelete = () => {
              ...
              // 真实业务请发起请求
              Api#MODEL_NAME_FIST_UP.delete(selectedRowKeys.value, (res: any) => {
            ...
            const handleClickEdit = (id?: any) => {
              router.push(`#MODULE/#MODEL_SPLIT_NAME-edit?id=${id ? id : ''}`);
            };
            // 单个删除按钮事件
