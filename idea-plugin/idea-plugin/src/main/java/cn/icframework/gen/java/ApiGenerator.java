...
import static cn.icframework.temp.java.ApiTemplate.*;
...
public class ApiGenerator {
    ...
    public static void build(Info info) {
        ...
        if (info.getTableInfo() != null) {
            tableComment = info.getTableInfo().getComment();
        }
        ...
        GenUtils.createFile(javaPath, info.getOver(), "ApiSys" + info.getModelNameFistUp() + ".java", buildApiContent);
        GenUtils.createFile(javaPath, info.getOver(), "ApiPublic" + info.getModelNameFistUp() + ".java", buildPublicContent);
        GenUtils.createFile(javaPath, info.getOver(), "ApiApp" + info.getModelNameFistUp() + ".java", buildAppContent);
    }
