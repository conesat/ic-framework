...
import static cn.icframework.temp.vue.VueApiTemplate.VUE_API_TEMPLATE;
...
public class VueApiGenerator {
    ...
    public VueApiGenerator(Info info) {
        this.info = info;
    }
    ...
    public void build() {
        ...
        GenUtils.createFile(savePath, info.getOver(), "Api" + info.getModelNameFistUp() + ".ts", VUE_API_TEMPLATE
