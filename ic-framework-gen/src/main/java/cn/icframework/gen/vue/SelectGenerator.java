...
import static cn.icframework.gen.template.vue.VueSelectTemplate.VUE_SELECT_TEMPLATE;
...
public class SelectGenerator {
    ...
    public SelectGenerator(Generator.Info info) {
        this.info = info;
    }
    ...
    public void build() {
        ...
        GenUtils.createFile(savePath, StringUtils.isEmpty(info.getPageVueSrcPath()), "select.vue", VUE_SELECT_TEMPLATE
