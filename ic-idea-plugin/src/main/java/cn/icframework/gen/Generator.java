    ...
    private void fitTableInfo() {
        ...
        do {
            ...
            for (PsiField field : fields) {
                ...
                PsiAnnotation version = field.getAnnotation("cn.icframework.mybatis.annotation.Version");
                if (tableFieldAnnotation == null && id == null && version == null) {
                    continue;
                }
                ...
                tableField.setVersion(version != null);
                ...
                if (tableFieldAnnotation != null) {
                    tableField.setOnInsertValue(StringUtils.isNotEmpty(PsiClassUtils.getAnnotationAttributeValueText(tableFieldAnnotation, "onInsertValue")));
                    tableField.setOnUpdateValue(StringUtils.isNotEmpty(PsiClassUtils.getAnnotationAttributeValueText(tableFieldAnnotation, "onUpdateValue")));
